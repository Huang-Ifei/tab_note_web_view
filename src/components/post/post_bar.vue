...
<template>
  <div style="display: flex;flex-direction: column;justify-content: center">
    ...
    <div
      ...
      <img alt="" @click.stop="leftOne" src="../../assets/arrow_back.svg" class="change_view_button_left">
      ...
      <img @click="rightOne" src="../../assets/arrow_forward.svg" class="change_view_button_right">
    </div>
    ...
    <div
      ...
      <div v-for="(small_button,i) in post_values" :id="small_button.post_id">
        <div @click="post_num=i" v-if="i==post_num" style="background: #1a98ee;width: 8px;height: 8px;border-radius: 8px;margin-right: 5px;cursor: pointer;color: #1a98ee;">

        </div>
        <div @click="post_num=i"  v-if="i!=post_num" style="background: #d7d7d7;width: 8px;height: 8px;border-radius: 8px;cursor: pointer;margin-right: 5px">
