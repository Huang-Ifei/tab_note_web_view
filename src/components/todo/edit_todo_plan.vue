  ...
  <div
    ...
    <div
      ...
      <div style="display: flex;flex-direction: column;justify-content: flex-start;">
        ...
        <button @click="updatePlan" style="margin-top: 10px;padding: 12px;font-size: 15px;  border:transparent;">
          {{ edit_button }}
        </button>
        <button @click="deletePlan"
                style="background: linear-gradient(45deg, #1e1e1e, #313131) ;margin-top: 10px;padding: 12px;font-size: 15px;  border:transparent;">
          {{ delete_button }}
        </button>
      </div>
    </div>
