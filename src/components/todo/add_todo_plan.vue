...
<template>
  <div style="color: #1c1c1c;width: 100%; height: 100%;background: rgba(28,28,28,0.5);border-radius: 10px;position: absolute;display: flex;flex-direction: column;justify-content: center;align-items: center;padding: 0">
    <div
        style="display: flex;flex-direction: column;justify-content: flex-start;z-index: 120;background: white;padding:  15px 10px 20px 10px;margin: 10px;border-radius: 6px;width: calc(100% - 50px)">
      <div
      ...
      <button @click="insertNewPlan" style="margin-top: 10px;padding: 12px;font-size: 15px; border:transparent;">
        {{ add_button }}
      </button>
    </div>
  </div>
